...
ALTER TABLE ONLY "public"."pantry"
    ADD CONSTRAINT "pantry_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id");



CREATE POLICY "Users can manage their own pantry" ON "public"."pantry" USING (("auth"."uid"() = "user_id"));
